...
static struct omap_mux __initdata am33xx_muxmodes[] = {
	...
	_AM33XX_MUXENTRY(LCD_DATA12, 0,
		"lcd_data12", "gpmc_a16", "eqep1b_in", "mcasp0_aclkr", 
		"mcasp0_axr2", NULL, "uart4_ctsn", "gpio0_8"),
	_AM33XX_MUXENTRY(LCD_DATA13, 0,
		"lcd_data13", "gpmc_a17", "eqep1b_in", "mcasp0_fsr", 
		"mcasp0_axr3", NULL, "uart4_rtsn", "gpio0_9"),
	_AM33XX_MUXENTRY(LCD_DATA14, 0,
		"lcd_data14", "gpmc_a18", "eqep1_index", "mcasp0_axr1", 
		"uart5_rxd", NULL, "uart5_ctsn", "gpio0_10"),
	...
	_AM33XX_MUXENTRY(SPI0_SCLK, 0,
		...
		NULL, NULL, "emu2_mux1", "gpio0_2"),
	_AM33XX_MUXENTRY(SPI0_D0, 0,
		"spi0_d0", "uart2_txd", "i2c2_scl", "ehrpwm0B", 
		NULL, NULL, "emu3_mux1", "gpio0_3"),
	_AM33XX_MUXENTRY(SPI0_D1, 0,
		"spi0_d1", "mmc1_sdwp", "i2c1_sda", "ehrpwm0_tripzone", 
	...
	_AM33XX_MUXENTRY(MCASP0_ACLKX, 0,
		...
		"mmc0_sdcd_mux1", NULL, NULL, "gpio3_14"),
	_AM33XX_MUXENTRY(MCASP0_FSX, 0,
		"mcasp0_fsx", "ehrpwm0b", NULL, "spi1_d0", 
		"mmc1_sdcd_mux1", NULL, NULL, "gpio3_15"),
	_AM33XX_MUXENTRY(MCASP0_AXR0, 0,
		"mcasp0_axr0", "ehrpwm0_tripzone", NULL, "spi1_d1", 
		"mmc2_sdcd_mux1", NULL, NULL, "gpio3_16"),
	_AM33XX_MUXENTRY(MCASP0_AHCLKR, 0,
		"mcasp0_ahclkr", "ehrpwm0_synci", "mcasp0_axr2", "spi1_sc0", 
		"ecap2_in_pwm2_out", NULL, NULL, NULL),
	...
	_AM33XX_MUXENTRY(XDMA_EVENT_INTR1, 0,
		...
		"timer7_mux1", NULL, "emu3_mux0", "gpio0_20"),
